...
import 'package:dev_fast_demo/bloc/speaker_bloc.dart';
...
class SpeakersScreenList extends StatefulWidget {
  const SpeakersScreenList({Key? key}) : super(key: key);
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      SpeakerDetailsScreen(speakerData: speakerData!)));
        },
        child: Card(
          shape:
                    ...
                    child: ClipRRect(
                        ...
                        child: Hero(
                          ...
                          child: speakerData.avatar != null
                              ...
                              : Image.asset("assets/noprofileuser.png"),
                        )),
                  ),
                  Padding(
